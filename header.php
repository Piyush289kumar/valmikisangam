      ...
      <div class="nav-bar" id="nav-bar">
        <nav>
          <ul>
            ...
            <li><a href="membership_form.php">रजिस्ट्रेशन फाॅर्म</a></li>
            <li><a href="coming_soon.php">शुभ मुहूर्त</a></li>
            <li><a href="astrology.php">ज्योतिषीय परामर्श</a></li>
            <li><a href="kundali_milan.php">कुंड़ली मिलान</a></li>
            <li><a href="post.php">सामाजिक गतिविधियाॅ</a></li>
            <!-- <li><a href="Kundali_milan.php">Kundali Milan</a></li> -->
            
            
            <!-- <li><a href="#">समाज के गौरव</a></li> -->
            <!-- <li><a href="#">आप के सुझाव</a></li>             -->
          </ul>
        </nav>
