    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-2">
                <a class="add-new" href="astro_users.php" style="background:#E1412E; border-radius: 16px; color:white; margin-bottom: 5px;">Jyotishi</a>
                </div>
                <div class="col-md-2">
            ...
            <div class="col-md-2">
                <a class="add-new" href="add-user.php" style="border-radius:16px;">Add Astro.</a>
            </div>
            <div class="col-md-12"  style="overflow:scroll">
                <table class="content-table">
                    ...
                    <tbody>
                        ...
                        $sql_show_user = "SELECT * FROM user WHERE role = '5' ORDER BY user_id DESC LIMIT {$offset},{$record_limit}";
                ...
                <?php
                $sql_user_show_by_page = "SELECT * FROM user WHERE role = '5'";
                ...
                if (mysqli_num_rows($result_sql_user_show_by_page) > 0) {
                    ...
                    if ($page_num_index_by_addbar > 1) {
                        echo ("<li><a href='astro_users.php?page_num_index=" . ($page_num_index_by_addbar - 1) . "'>Prev</a></li>");
                    }
                    for ($i = 1; $i <= $total_page; $i++) {
                        ...
                        echo ("<li class=$active_page><a href='astro_users.php?page_num_index=$i'>$i</a></li>");
                    }

                    if ($page_num_index_by_addbar < $total_page) {
                        echo ("<li><a href='astro_users.php?page_num_index=" . ($page_num_index_by_addbar + 1) . "'>Next</a></li>");
                    }
                    echo ("</ul>");
                }
                ?>
