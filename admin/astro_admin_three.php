            ...
            <div class="col-md-12 text-center">
                ...
                <div class="col-md-2">
                    <a class="add-new" href="astro_admin.php"
                        style="border-radius: 16px; color:white; margin-bottom: 5px;">वैवाहिक मिलान</a>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <a class="add-new" href="astro_admin_three.php"
                        style="background:#E1412E; border-radius: 16px; color:white; margin-bottom: 5px;">ETC</a>
                </div>
            </div>
            <div class="col-md-10">
            ...
            <div class="col-md-12"  style="overflow:scroll">
                <table class="content-table">
                    ...
                    <tbody>
                        ...
                        WHERE astro_talk.astro_category != 'वैवाहिक मिलान' AND astro_talk.astro_category != 'समस्या समाधान' ORDER BY form_id DESC LIMIT {$offset},{$record_limit}";
